 ...
 * 
 * 80 ratio
 * 150 List(List(313, 260, 220, 206), List(300, 280, 206, 213), List(273, 226, 246, 253), List(113, 233, 326, 326))  List(List(47, 39, 33, 31), List(45, 42, 31, 32), List(41, 34, 37, 38), List(17, 35, 49, 49)) List((228,2), (194,0), (161,1), (116,3))
 * 
 * 
 * 
 */
class tb007(seed: Long) extends agentAbstract {

 // var currPlan: agentAbstract = null
  var ra = new Random(0x883789 ^ seed)
  val MinValForPlan = 3
  
  val firstPhaseBot=new tb003

  
  val ratioEmptyUp = 95
  val ratioEmptydown = 80
  ...
  def doTakeEmpty(ref: GameState4P) = {
    ...
    if ((ref.tr.void.countBitset < ratioEmptydown * (GameState4P.WH) / 100) || (ref.tr.void.countBitset > ratioEmptyUp * (GameState4P.WH) / 100)) {
      ...
      this.firstPhaseBot.genMove(ref)
    }
